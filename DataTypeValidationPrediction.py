...
class DbOperationMongoDB:
    ...
    def insertIntoTableGoodData(self,column_names):
        ...
        try:
            ...
            database_name = "cred_prediction_log"
            collection_name = "db_insert_log"
            self.mongodb.drop_collection(prediction_database,prediction_collection)
            ...
            for file in files:
                try:
                    ...
                    self.mongodb.insert_df(prediction_database, prediction_collection, df)
    ...
    def selectingDatafromtableintocsv(self,):
        ...
        try:
            ...
            df=self.mongodb.get_df_from_collect(prediction_database,prediction_collection)
